...
import space.octaone.alcubierre.reduce.ScreenStackNavReducer
 ...
 * @see ScreenRootNavReducer
 */
public data class NewStack<S : Screen, D : Dialog>(val stackId: Int, val screens: List<S>) :
    NavAction<S, D>
 ...
 * @see ScreenStackNavReducer
 */
public data class BackTo<S : Screen, D : Dialog>(val screen: S, val inclusive: Boolean) :
    NavAction<S, D>
 ...
 * @see ScreenRootNavReducer
 */
public data class ApplyState<S : Screen, D : Dialog>(val state: RootNavState<S, D>) :
    NavAction<S, D>
 ...
 */
public data class Batch<S : Screen, D : Dialog>(val actions: List<NavAction<S, D>>) :
    NavAction<S, D>
