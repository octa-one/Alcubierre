 ...
 *
 * Each reducer has access to the head to have an ability ti restart the entire chain.
 ...
 * But after DeeplinkReducer, there are no more reducers for Forward reducing.
