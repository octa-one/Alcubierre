 ...
 */
public fun generateReflectionConverter(info: DeeplinkInformation): CodeBlock = buildCodeBlock {
    ...
    var maskAllSet = -1 // mask value if all parameters != null
...
private val DEFAULT_CONSTRUCTOR_MARKER_TYPE_BLOCK = CodeBlock.of(
    "%M",
    MemberName("com.github.octaone.alcubierre.deeplink.processor.api", "_DEFAULT_CONSTRUCTOR_MARKER")
)
